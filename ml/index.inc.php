...
<title>Title of the document</title>
  ...
  <meta name="description" content="Atari ColdFire Project - Mailinglist">
...
<div id="container">
	...
	<p>To see the collection of prior postings to the list, visit the Atari-coldfire Archives. (The current archive is only available to the list members.)</p>

	<div id="subheader">Using the Atari ColdFire Mailinglist:</div>
	<p>To post a message to all the list members, send an email to atari-coldfire@acp-devel.org. To Manage your subscription, you can use the sections below.</p>
